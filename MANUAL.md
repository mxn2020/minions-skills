# Manual Setup Steps for Minions Skills
...
Go to **GitHub → mxn2020/minions-skills → Settings → Secrets and variables → Actions** and add:

| Secret | Description | Where to get it |
|--------|-------------|-----------------|
| `NPM_TOKEN` | npm publish token | [npmjs.com → Access Tokens](https://www.npmjs.com/settings/~/tokens) |
| `PYPI_TOKEN` | PyPI API token for `minions-skills` | [pypi.org → Account Settings → API tokens](https://pypi.org/manage/account/#api-tokens) |
...
### Web App (Playground)
- **Netlify site name**: `minions-skills-web`
- **GitHub repo**: `mxn2020/minions-skills`
- **Base directory**: `apps/web`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/web/dist`
- **Custom domain**: `skills.minions.wtf`

### Documentation
- **Netlify site name**: `minions-skills-docs`
- **GitHub repo**: `mxn2020/minions-skills`
- **Base directory**: `apps/docs`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/docs/dist`
- **Custom domain**: `skills.minions.help`

### Blog
- **Netlify site name**: `minions-skills-blog`
- **GitHub repo**: `mxn2020/minions-skills`
- **Base directory**: `apps/blog`
- **Build command**: `pnpm run build`
- **Publish directory**: `apps/blog/dist`
- **Custom domain**: `skills.minions.blog`
...
|--------|------|------|-------|
| Docs | CNAME | `skills.minions.help` | _(Netlify subdomain)_ |
| Blog | CNAME | `skills.minions.blog` | _(Netlify subdomain)_ |
| App  | CNAME | `skills.minions.wtf` | _(Netlify subdomain)_ |
...
Your packages:
- SDK: [`@minions-skills/sdk`](https://www.npmjs.com/package/@minions-skills/sdk)
- CLI: [`@minions-skills/cli`](https://www.npmjs.com/package/@minions-skills/cli)
...
Your package: [`minions-skills`](https://pypi.org/project/minions-skills/)
...
| Item | Value |
|------|-------|
| Project | `minions-skills` |
| SDK (npm) | `@minions-skills/sdk` |
| CLI (npm) | `@minions-skills/cli` |
| Python (PyPI) | `minions-skills` |
| GitHub | `github.com/mxn2020/minions-skills` |
| Docs domain | `skills.minions.help` |
| Blog domain | `skills.minions.blog` |
| App domain | `skills.minions.wtf` |
