...
- `@minions-skills/sdk` (npm package)
- `minions-skills` (PyPI package)
- `@minions-skills/cli` (npm package)
- The minions-skills web playground
- The minions-skills documentation site
