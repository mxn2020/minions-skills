...
/**
 * @minions-skills/cli — CLI for Minions skills
 */
...
import { customTypes } from '@minions-skills/sdk';
...
program
    ...
    .action(() => {
        console.log(chalk.bold('Minions skills'));
        console.log(chalk.dim('Reusable skill definitions that agents can load, compose, and version'));
        console.log('');
        console.log(`  SDK:    ${chalk.cyan('@minions-skills/sdk')}`);
        console.log(`  CLI:    ${chalk.cyan('@minions-skills/cli')}`);
        console.log(`  Python: ${chalk.cyan('minions_skills')}`);
